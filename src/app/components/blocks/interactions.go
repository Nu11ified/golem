...
// (identical to stub version — pure logic, no JS dependency)
...
// Note: SetupBlockKeyHandler and FocusBlock are WASM-only functions
// that will be wired up when the editor page is assembled.
// They use syscall/js and aren't needed for the stub build.
